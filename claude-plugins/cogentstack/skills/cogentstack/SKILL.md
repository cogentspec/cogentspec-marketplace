...
Treat `$cogentstack`, a direct skill invocation, and a natural-language request to connect CogentSpec as the same request.
...
- Never open, close, select, inventory, or repurpose browser tabs as part of `$cogentstack`.
